...
$ReleaseFiles = @(
    @{ Relative = "holycrab/scripts/holycrab_cli.py"; Name = "holycrab_cli.py"; Sha256 = "d585cfa6fc75c4927a83cdddb8087b92b5b393a42a54befea47bc797fe2b4a9c" },
    ...
    if (Test-Path -LiteralPath $PreviousManifestPath) {
        try {
            ...
            $PreviousPathManaged = (
                ...
                $PreviousManifest.pathRegistration.directory.TrimEnd([IO.Path]::DirectorySeparatorChar) -ieq
