...
After every authorization, upload, wait, or generation result, read `nextAction`, explain the result in the user's current language, and show the next command. Do not dump raw JSON without an explanation to a non-technical user.
